...
class AccountController extends Controller
{
    ...
    public function signupAction()
    {
        ...
        return $this->render(array(
            // ビューファイルで変数の存在をチェックするより
            // アクション側で空の変数を指定するほうがビューファイルの見通しがよくなる
            'user_name' => '',
            'password'  => '',
    ...
    public function registerAction()
    {
        ...
        } else if (!preg_match('/^\w{3,20}$/', $user_name)) {  // \w は半角英数字とアンダースコア
        ...
        return $this->render(array(
            ...
            'errors'    => $errors,
            '_token'    => $this->generateCsrfToken('account/signup'),
        ), 'signup'); // render メソッドの第2引数にテンプレートの名前を指定できる
    }
